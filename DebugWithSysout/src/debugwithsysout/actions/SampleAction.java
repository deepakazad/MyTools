package debugwithsysout.actions;
...
public class SampleAction implements IWorkbenchWindowActionDelegate {
	...
	public void run(IAction action) {
		// TODO: Could enable and disable DebugStream here! or could take out the UI

		MessageDialog.openInformation(window.getShell(), "DebugWithSysout", "Hello, Eclipse world");
	}
